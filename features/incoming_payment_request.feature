Feature: Incoming Payment Request
  ...
  Scenario: A payment request is received but it was not from the configured external application
    ...
    And a verification request should be made to the configured external application for 347752 with external_id: "347752", amount: "5000.00", currency: "THB", to: "someone@gmail.com"
